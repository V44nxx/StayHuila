            ...
            if tipo is None or tipo == 'hospedaje':
                cur.execute("""
                    SELECT DISTINCT h.id, h.nombre, h.municipio, h.precio_noche as precio, 'hospedaje' as tipo,
                           ...
                           i.url as imagen, h.tipo as sub_tipo, h.destacado
                    FROM hospedajes h
                    LEFT JOIN hospedaje_imagenes i ON h.id = i.hospedaje_id AND i.es_portada = 1
            ...
            if tipo is None or tipo == 'experiencia':
                cur.execute("""
                    SELECT DISTINCT e.id, e.nombre, e.municipio, e.precio_persona as precio, 'experiencia' as tipo,
                           ...
                           i.url as imagen, e.tipo as sub_tipo, e.destacado
                    FROM experiencias e
                    LEFT JOIN experiencia_imagenes i ON e.id = i.experiencia_id AND i.es_portada = 1
...
STATIC_TRANSLATIONS = {
    'en': {
        ...
        'Volver al inicio': 'Back to home', 'Pon tu espacio en StayHuila': 'Host Panel',
    ...
    'pt': {
        ...
        'Volver al inicio': 'Voltar ao início', 'Pon tu espacio en StayHuila': 'Painel do Anfitrião',
    ...
    'fr': {
        ...
        'Volver al inicio': 'Retour à l\'accueil', 'Pon tu espacio en StayHuila': 'Tableau de l\'hôte',
    ...
    'it': {
        ...
        'Volver al inicio': 'Torna alla home', 'Pon tu espacio en StayHuila': 'Pannello Host',
